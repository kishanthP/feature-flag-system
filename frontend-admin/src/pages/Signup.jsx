...
export default function Signup() {
  ...
  return (
    ...
    >
      <Card sx={{ width: 440, borderRadius: 3, border: '1px solid rgba(16,185,129,0.2)' }}>
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3 }}>
            ...
            <Typography variant="h5" fontWeight={700}>Admin Sign Up</Typography>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            <TextField
              id="signup-name" label="Full Name" name="name"
              value={form.name} onChange={handleChange}
              required fullWidth autoFocus
            />
            <TextField
              id="signup-email" label="Email" name="email" type="email"
            ...
            />
            <TextField
              id="signup-org" label="Organization" name="organizationId"
              select value={form.organizationId} onChange={handleChange}
              required fullWidth
            >
              {orgs.length === 0 ? (
                <MenuItem disabled value="">No organizations found</MenuItem>
              ) : (
                orgs.map((org) => (
            ...
            <Button
              id="signup-btn" type="submit" variant="contained"
